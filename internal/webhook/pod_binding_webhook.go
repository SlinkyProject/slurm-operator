...
// +kubebuilder:webhook:path=/mutate--v1-binding,mutating=true,failurePolicy=ignore,matchPolicy=Equivalent,sideEffects=None,groups="",resources=pods/binding,verbs=create,versions=v1,name=podsbinding-v1.kb.io,admissionReviewVersions=v1
// NOTE: objectSelector and failurePolicy are manually maintained in
// config/webhook/manifests.yaml and helm template.
