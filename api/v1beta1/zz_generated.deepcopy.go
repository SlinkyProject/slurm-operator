...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RestApiPodDisruptionBudget) DeepCopyInto(out *RestApiPodDisruptionBudget) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RestApiPodDisruptionBudget.
func (in *RestApiPodDisruptionBudget) DeepCopy() *RestApiPodDisruptionBudget {
	if in == nil {
		return nil
	}
	out := new(RestApiPodDisruptionBudget)
	in.DeepCopyInto(out)
	return out
}
