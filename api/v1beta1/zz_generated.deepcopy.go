...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AccountingLimits) DeepCopyInto(out *AccountingLimits) {
	*out = *in
	if in.Fairshare != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccountingLimits.
func (in *AccountingLimits) DeepCopy() *AccountingLimits {
	if in == nil {
		return nil
	}
	out := new(AccountingLimits)
	in.DeepCopyInto(out)
	return out
}
