...
`features.slinky.slurm.net/spec` annotation, the operator applies its values to
the Slurm node's available and active features under a reserved `k8s/` prefix,
