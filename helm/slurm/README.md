...
![Version: 1.1.3](https://img.shields.io/badge/Version-1.1.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 25.11](https://img.shields.io/badge/AppVersion-25.11-informational?style=flat-square)
...
| nodesets | map[string]object | `{"slinky":{"enabled":true,"extraConf":null,"extraConfMap":{},"logfile":{"image":{"repository":"docker.io/library/alpine","tag":"latest"},"resources":{}},"metadata":{},"ordinalPadding":0,"partition":{"config":null,"configMap":{},"enabled":false},"podSpec":{"affinity":{},"initContainers":[],"nodeSelector":{"kubernetes.io/os":"linux"},"resources":{},"tolerations":[],"volumes":[]},"replicas":1,"scalingMode":"StatefulSet","slurmd":{"args":[],"env":[],"image":{"repository":"ghcr.io/slinkyproject/slurmd","tag":"25.11-ubuntu24.04"},"lifecycle":{},"resources":{},"volumeMounts":[]},"ssh":{"enabled":false,"extraSshdConfig":null},"taintKubeNodes":false,"updateStrategy":{"rollingUpdate":{"maxUnavailable":"25%"},"type":"RollingUpdate"},"workloadDisruptionProtection":true}}` | Slurm NodeSet (slurmd) configurations. |
...
| nodesets.slinky.slurmd.lifecycle | corev1.Lifecycle | `{}` | The container lifecycle hooks. A `preStop` hook set here replaces the operator default, which marks the Slurm node down and deletes its record as the pod terminates: `scontrol update nodename=$(hostname) state=down reason='slurm-operator: Pod is terminating' && scontrol delete nodename=$(hostname);` Ref: https://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/ |
