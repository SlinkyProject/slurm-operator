...
| accounting.slurmdbd.image | string \| object | `{"digest":"","repository":"ghcr.io/slinkyproject/slurmdbd","tag":"25.11-ubuntu24.04"}` | The image to use. Ref: https://kubernetes.io/docs/concepts/containers/images/#image-names |
...
| controller.logfile.image | string \| object | `{"digest":"","repository":"docker.io/library/alpine","tag":"latest"}` | The image to use. Ref: https://kubernetes.io/docs/concepts/containers/images/#image-names |
...
| controller.reconfigure.image | string \| object | `{"digest":"","repository":"ghcr.io/slinkyproject/slurmctld","tag":"25.11-ubuntu24.04"}` | The image to use. Ref: https://kubernetes.io/docs/concepts/containers/images/#image-names |
...
| controller.slurmctld.image | string \| object | `{"digest":"","repository":"ghcr.io/slinkyproject/slurmctld","tag":"25.11-ubuntu24.04"}` | The image to use. Ref: https://kubernetes.io/docs/concepts/containers/images/#image-names |
...
| loginsets | map[string]object | `{"slinky":{"enabled":false,"extraSshdConfig":null,"initconf":{"image":{"digest":"","repository":"docker.io/library/alpine","tag":"latest"},"resources":{}},"login":{"env":[],"image":{"digest":"","repository":"ghcr.io/slinkyproject/login","tag":"25.11-ubuntu24.04"},"resources":{},"securityContext":{"privileged":false},"volumeMounts":[]},"metadata":{},"podSpec":{"affinity":{},"initContainers":[],"nodeSelector":{"kubernetes.io/os":"linux"},"resources":{},"tolerations":[],"volumes":[]},"replicas":1,"rootSshAuthorizedKeys":null,"service":{"metadata":{},"spec":{"type":"LoadBalancer"}},"strategy":{}}}` | Slurm LoginSet (sackd, sshd, sssd) configurations. |
...
| loginsets.slinky.initconf.image | string \| object | `{"digest":"","repository":"docker.io/library/alpine","tag":"latest"}` | The image to use. Ref: https://kubernetes.io/docs/concepts/containers/images/#image-names |
...
| loginsets.slinky.login.image | string \| object | `{"digest":"","repository":"ghcr.io/slinkyproject/login","tag":"25.11-ubuntu24.04"}` | The image to use. Ref: https://kubernetes.io/docs/concepts/containers/images/#image-names |
...
| nodesets | map[string]object | `{"slinky":{"enabled":true,"extraConf":null,"extraConfMap":{},"logfile":{"image":{"digest":"","repository":"docker.io/library/alpine","tag":"latest"},"resources":{}},"metadata":{},"ordinalPadding":0,"partition":{"config":null,"configMap":{},"enabled":false},"pinToNode":false,"podSpec":{"affinity":{},"initContainers":[],"nodeSelector":{"kubernetes.io/os":"linux"},"resources":{},"tolerations":[],"volumes":[]},"replicas":1,"scalingMode":"StatefulSet","slurmd":{"args":[],"env":[],"image":{"digest":"","repository":"ghcr.io/slinkyproject/slurmd","tag":"25.11-ubuntu24.04"},"resources":{},"volumeMounts":[]},"ssh":{"enabled":false,"extraSshdConfig":null},"taintKubeNodes":false,"updateStrategy":{"rollingUpdate":{"maxUnavailable":"25%"},"type":"RollingUpdate"},"workloadDisruptionProtection":true}}` | Slurm NodeSet (slurmd) configurations. |
...
| nodesets.slinky.logfile.image | string \| object | `{"digest":"","repository":"docker.io/library/alpine","tag":"latest"}` | The image to use. Ref: https://kubernetes.io/docs/concepts/containers/images/#image-names |
...
| nodesets.slinky.slurmd.image | string \| object | `{"digest":"","repository":"ghcr.io/slinkyproject/slurmd","tag":"25.11-ubuntu24.04"}` | The image to use. Ref: https://kubernetes.io/docs/concepts/containers/images/#image-names |
...
| restapi.slurmrestd.image | string \| object | `{"digest":"","repository":"ghcr.io/slinkyproject/slurmrestd","tag":"25.11-ubuntu24.04"}` | The image to use. Ref: https://kubernetes.io/docs/concepts/containers/images/#image-names |
