...
| nodesetDefaults.preferKubernetesNodeName | bool | `false` | Prefer Node-derived Slurm names for pinned, non-oversubscribed StatefulSets; otherwise use Pod hostnames. Immutable preference, defaults to false. DaemonSet naming is unchanged. |
