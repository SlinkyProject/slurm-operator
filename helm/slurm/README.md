...
| restapi.pdb.maxUnavailable | int \| string | `nil` | Maximum number of pods that can be unavailable after eviction. Can be an absolute number (ex: 1) or a percentage (ex: 25%). Takes precedence over `minAvailable` when set. |
