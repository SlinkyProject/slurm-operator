...
| jwtHs256KeyRef | secretKeyRef | `{"annotations":{},"create":true,"key":"jwt_hs256.key","name":"slurm-auth-jwths256"}` | Slurm cluster JWT HS256 authentication key. Ref: https://slurm.schedmd.com/authentication.html#jwt |
| jwtHs256KeyRef.annotations | object | `{}` | Additional annotations to add to the secret. |
| jwtHs256KeyRef.create | bool | `true` | The secret will be created when true. |
| jwtHs256KeyRef.key | string | `"jwt_hs256.key"` | The key within the secret. |
| jwtHs256KeyRef.name | string | `"slurm-auth-jwths256"` | The name of the secret. |
...
| slurmKeyRef | secretKeyRef | `{"annotations":{},"create":true,"key":"slurm.key","name":"slurm-auth-slurm"}` | Slurm shared authentication key. Ref: https://slurm.schedmd.com/authentication.html#slurm |
| slurmKeyRef.annotations | object | `{}` | Additional annotations to add to the secret. |
| slurmKeyRef.create | bool | `true` | The secret will be created when true. |
| slurmKeyRef.key | string | `"slurm.key"` | The key within the secret. |
| slurmKeyRef.name | string | `"slurm-auth-slurm"` | The name of the secret. |
